---
title: "accessible-list-item-design"
source: https://www.ksharma.xyz/accessibility-list-item-android-jetpack-compose
date: 2023-01
type: blog
---
# 
...
Accessible List Item Design in Android: Jetpack Compose
...
![A sample image with an email icon and a title and subtitle text. At the end of image there is a right arrow icon](images/accessibility-list-item-android-jetpack-compose/img-1.webp)

![A sample image with an shopping cart icon and a title and subtitle text. An info icon at the right end.](images/accessibility-list-item-android-jetpack-compose/img-2.webp)

In most mobile applications, there is a common list element layout which has a left icon, a title, a subtitle and a right icon. This UI element is generally a part of a list. Sounds very common isn’t it ? And it is very easy to create one.  
For example, let's imagine the following design layout received as part of Figma layout. The developers may usually interpret the layout in their own terms.
...
![](images/accessibility-list-item-android-jetpack-compose/img-3.webp)
...
![](images/accessibility-list-item-android-jetpack-compose/img-4.webp)
...
![](images/accessibility-list-item-android-jetpack-compose/img-5.webp)
...
![](images/accessibility-list-item-android-jetpack-compose/img-6.webp)
...
![](images/accessibility-list-item-android-jetpack-compose/img-7.webp)
